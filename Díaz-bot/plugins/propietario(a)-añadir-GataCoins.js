...
if (!txt) throw `${ag}𝙄𝙉𝙂𝙍𝙀𝙎𝙀 𝙇𝘼 𝘾𝘼𝙉𝙏𝙄𝘿𝘼𝘿 𝘿𝙀 〔 𝗗𝗶𝗮𝘇 𝗕𝗼𝘁 〕\n\n𝙀𝙉𝙏𝙀𝙍 𝙏𝙃𝙀 𝙉𝙐𝙈𝘽𝙀𝙍 𝙊𝙁 〔 𝗗𝗶𝗮𝘇 𝗕𝗼𝘁 〕`
...
money += pjk
if (money < 1) throw `${mg}𝙀𝙇 𝙉𝙐𝙈𝙀𝙍𝙊 𝙈𝙄𝙉𝙄𝙈𝙊 𝘿𝙀 〔 𝗗𝗶𝗮𝘇 𝗕𝗼𝘁 〕 𝙀𝙎 *1*\n\n𝙏𝙃𝙀 𝙈𝙄𝙉𝙄𝙈𝙐𝙈 𝙉𝙐𝙈𝘽𝙀𝙍 𝙁𝙍𝙊𝙈 〔 𝗗𝗶𝗮𝘇 𝗕𝗼𝘁 〕 𝙄𝙎 *1*`
let users = global.db.data.users
//let users = global.db.data.users[who]
users[who].money += gatacoins
m.reply(`╭━━━[ 𝗗𝗶𝗮𝘇 𝗕𝗼𝘁 🥷🏻 ]━━━⬣\n┃\n┃ღ *PARA | FOR:*\n┃ღ ${text}\n┃┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈\n┃ღ *SE LE AÑADIÓ | NOW YOU HAVE*\n┃ღ *${gatacoins} DiazCoin(s)* 🤖\n┃\n╰━━━━━━━━━━━━━━⬣\n\n${wm}`)}
/*conn.sendHydrated(m.chat, `╭━━━[ 𝗗𝗶𝗮𝘇 𝗕𝗼𝘁 🥷🏻 ]━━━⬣\n┃\n┃ღ *PARA | FOR:*\n┃ღ *${text}*\n┃┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈\n┃ღ *SE LE AÑADIÓ | NOW YOU HAVE*\n┃ღ *${gatacoins} GataCoin(s)* 🐈\n┃\n╰━━━━━━━━━━━━━━⬣`, wm, null, md, '𝙂𝙖𝙩𝙖𝘽𝙤𝙩-𝙈𝘿', null, null, [
